...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { age: @tutor.age, name: @tutor.name, email: @tutor.email, subjects: @tutor.subjects }
    end
  ...
  test "should update tutor" do
    put :update, id: @tutor, tutor: { age: @tutor.age, name: @tutor.name, email: @tutor.email, subjects: @tutor.subjects }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
